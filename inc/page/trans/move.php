...
echo "            <div id='card-header' class='card-header p-0 position-relative mt-n4 mx-3 z-index-2'> ";
echo "              <div id='div-usr-slct' class='bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3'> ";
...
echo "            <div class='card-header p-0 position-relative mt-n4 mx-3 z-index-2'> ";
echo "              <div class='bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3'> ";
echo "                <h6 class='text-white text-capitalize ps-3'>Availible locations</h6> ";
echo "              </div> ";
echo "            </div> ";
echo "            <div class='card-body px-0 pb-2'> ";
echo "               <div id='loc-card-container' class='row mx-3 justify-content-center'> ";
echo "               </div> ";
echo "            </div> ";
echo "          </div> ";
echo "        </div> ";
...
echo " function generateLocationCards(data){";
echo "    const parent = $('#loc-card-container'); ";
echo "    parent.empty(); ";
echo "    for (i in data){";
echo "        const locCard = getLocationCard(data[i], moveToLocationHandler);";
echo "        parent.append(locCard.card); ";
echo "        locCard.btn.prop('disabled', transportData.parentId == data[i].id); ";
echo "    }";
echo " }";

echo " function moveToLocationHandler(data){";

echo "   let req = {};  ";
echo "   req.MD = '".AjaxManager::MD_LOC_TRANS_MOVE."';    ";
echo "   req.ELEM = transportData.uuid;    ";
echo "   req.PRNT_TO = data.uuid;    ";
...
echo "   let req = {};  ";
echo "   req.MD = '".AjaxManager::MD_LOC_AVAILIBLE_GET."';    ";
echo "   req.ELEM = data;    ";
...
echo "       success: function(data) { ";
echo "           const code = data.CODE; ";
echo "           const locData = data.DATA; ";
echo "           if(code == 200){ ";
echo "              generateLocationCards(locData); ";
echo "           } ";
echo "           else if(code == 401){ ";
echo "               redirectToLogin(); ";
echo "           } ";
