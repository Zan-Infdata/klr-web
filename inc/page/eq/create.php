...
echo "             <h4 class='font-weight-bolder'>New Equipment</h4> ";
echo "             <p class='mb-0'>Create equipment</p> ";
echo "         </div> ";
...
echo " function checkValues(data, wrhId, typeId){";
echo "    let check = true;";
...
echo "   if(!checkValues(elemData, wrhId, typeId)){";
echo "      return; ";
echo "   }";

echo "   let req = {};  ";
echo "   req.MD = '".AjaxManager::MD_EQ_CREATE."';    ";
